package com.example.demoback.common.mybatisplus.advisor;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.example.demoback.common.mybatisplus.annotaion.*;
import com.example.demoback.common.mybatisplus.exception.CopycatException;
import com.example.demoback.common.mybatisplus.parser.CriteriaFieldParser;
import com.example.demoback.common.mybatisplus.processor.*;
...
public class CriteriaAnnotationProcessorAdvisor {
     ...
     * 条件注解处理器缓存
     */
    private static Map<Class<? extends Annotation>, CriteriaAnnotationProcessor> ANNOTATION_PROCESSOR_CACHE = null;
